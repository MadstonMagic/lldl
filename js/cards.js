$(document).ready( function() {
	...
	var cardsDate = randomDateNoRepeats([
		...
		'Een partner met een goed inkomen of met veel liefde voor zijn/haar partner?',
		...
		'Hoe vaak denk je aan intimiteit? En heb je daar vandaag al aangedacht?', 
		'Geef ik je een goed gevoel van binnen?',
		'Hoe zou je reageren als ik je nu zou zoenen?',
		'Vind jij jezelf goed in bed?',
		'Vind je smakken tijdens het eten een (grote) afknapper?',
	...
	var cardsPartner = randomPartnerNoRepeats([
		...
		'How vind jij het fijn om intiem aangeraakt te worden?',
		...
		'Wat is je meest ontdeugende fantasie dat je nog uit wilt proberen?',
